...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        await message.reply_text(
            text=f"<b>›› 𝚃𝙷𝙰𝙽𝙺𝚂 F𝙾R 𝙰𝙳𝙳ING 𝙼𝙴 𝚃𝙾 𝚈𝙾𝚄𝚁 𝙶𝚁𝙾𝚄𝙿.\n›› 𝙳𝙾𝙽'𝚃 𝙵𝙾𝚁𝙶𝙴𝚃 𝚃𝙾 𝙼𝙰𝙺𝙴 𝙼𝙴 𝙰𝙳𝙼𝙸𝙽.\n›› 𝙸𝚂 THERE 𝙰𝙽𝚈 𝙳𝙾𝚄𝙱𝚃𝚂 𝙰𝙱𝙾𝚄𝚃 𝚄𝚂𝙸𝙽𝙶 𝙼𝙴 𝙲𝙻𝙸𝙲𝙺 THE 𝙱𝙴𝙻𝙾𝚆 𝙱𝚄𝚃𝚃𝙾𝙽..⚡⚡.</b>",
            reply_markup=reply_markup)
    else:
...
async def disable_chat(bot, message):
    ...
    if not cha_t:
        return await message.reply("Chat Not Found In My DB")
